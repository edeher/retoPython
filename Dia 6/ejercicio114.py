"""Utiliza el método `writelines` para escribir los valores de la lista que se
muestra a continuación al final del archivo "registro.txt".
...
\t. También, deberás cerrar el archivo en modo escritura y volverlo a
abrir en modo lectura para poder imprimir su contenido.
"""
...
for l1 in registro_ultima_sesion:
    archivo.writelines(l1 + "\t")
