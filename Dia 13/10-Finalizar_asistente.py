...
def pedir_hora():
    ...
    hora = f'son las {hora.hour} horas y {hora.minute} con {hora.second} segun'
    print(hora)
    # decir la hora
    hablar(hora)
...
def saludo_inicial():
    ...
    # decir saludo
    hablar(f'''
           hola {momento}, soy tu asistente personal.
...
def pedir_cosas():
    ...
    while comenzar:
        ...
        if 'abrir youtube' in pedido:
            ...
            hablar('esto es lo que enocntre')
            continue
        elif 'reproducir' in pedido:
            hablar('buena idea, ahora empeizo')
